...
function OpenButton({clickAction}: OpenButtonProps) {
  return (
    <button className="p-0 rounded-lg" onClick={clickAction}>
      <svg className="w-6 h-6 md:w-7 md:h-7 text-gray-800 dark:text-white hover:text-gray-600 dark:hover:text-gray-400 cursor-pointer transition-transform transform hover:scale-110" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
