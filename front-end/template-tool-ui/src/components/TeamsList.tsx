        ...
        <ul className="space-y-2 pt-2">
          {loading ? (
            ...
            owners.map((team, index) => (
              <li key={index} className="border-4 rounded-3xl border-green-500 p-2 w-5/6 mx-auto cursor-pointer" onClick={() => addNotification(`${team.name} clicked`, NotificationType.INFO)}>
